      ...
      <header className="top-navbar" style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
          ...
          <div style={{ fontSize: '0.85rem', color: 'var(--text-muted)', fontWeight: 500, borderLeft: '1px solid var(--border-light)', paddingLeft: '1.5rem' }}>
            Welcome, <span style={{ color: 'var(--text-main)', fontWeight: 700 }}>{user?.name || 'Engineer'}</span>
          </div>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
          ...
          <div className="notification-bell" style={{ color: 'var(--text-main)', cursor: 'pointer', position: 'relative', background: 'var(--nav-hover-bg)', width: '35px', height: '35px', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center' }} onClick={() => navigate('/engineer/active')}>
            <Bell size={18} />
      ...
      <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        <aside className="sidebar" style={{ 
          ...
          <div className="sidebar-header" style={{ padding: '1.5rem 0', textAlign: 'center' }}>
            ...
            {!isCollapsed && <p style={{fontSize: '0.6rem', color: 'var(--text-muted)', marginTop: '0.4rem', letterSpacing: '1.5px', fontWeight: 900 }}>ENGINEER PORTAL</p>}
          </div>
